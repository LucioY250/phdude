...
`phdude data add`, `phdude table add`, `phdude table build`, `phdude figure add`,
`phdude figure build`, `phdude manuscript init`, `phdude manuscript submit`,
`phdude manuscript approve`, `phdude manuscript reopen`, or
...
`packs list|detect`, `authors list|show`, `data list|show|profile`, `table list|show`,
`figure list|show|check`, `manuscript list|show|status`, `prose`, `doctor`,
