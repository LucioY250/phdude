---
description: Add a candidate claim, evidence, fact, source, question, hypothesis, method, result, or artifact-role.
...
(`<claim|evidence|fact|source|question|hypothesis|method|result|artifact-role> --json '<obj>'`.)
