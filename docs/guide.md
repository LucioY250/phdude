...
This is the long-form reference: what PhDude is, how it works, and every part of the loop worked
through end to end. The [README](../README.md) is the short version — install it, see the demo,
run eight commands. Come here when you want the reasoning and the detail.
...
- **The contracts are frozen.** Every schema carries `x-phdude: { stability: stable, since }`, and
  ...
  migration comes with it. Every command in [docs/cli.md](cli.md) is marked stable, and the
  exit codes and the `--json` error envelope are held there by a contract test.
  [docs/versioning.md](versioning.md) says exactly what that covers and what it does not.
- **A documented extension API.** Seven ports — search provider, document parser, document
  ...
  See [docs/extension-api.md](extension-api.md).
...
- **The guides that were missing.** How to migrate a workspace and how to write a migration
  ([docs/migration.md](migration.md)), how to write a skill
  ([docs/skills-authoring.md](skills-authoring.md)), how to write a pack
  ([docs/packs-authoring.md](packs-authoring.md)), and what PhDude will never become
...
<p align="center"><img src="assets/diagrams/loop.svg" alt="You talk to the agent, the agent runs the phdude CLI, the CLI validates and logs every write into the research workspace" width="900"></p>
...
<p align="center"><img src="assets/diagrams/layers.svg" alt="Four layers: adapters, skills, packs and core" width="900"></p>
...
<p align="center"><img src="assets/diagrams/ingest.svg" alt="Ingestion pipeline: discover, inventory, dedup, extract, cache, link versions, record" width="900"></p>
...
<p align="center"><img src="assets/diagrams/lineage.svg" alt="Lineage from an artifact through source, evidence and claim to a research question" width="900"></p>
...
<p align="center"><img src="assets/diagrams/states.svg" alt="Knowledge states: candidate, supported, canonical, disputed, rejected" width="900"></p>
...
<p align="center"><img src="assets/diagrams/next.svg" alt="How the next action is chosen: snapshot, the rules, ranking, top action with reasons" width="900"></p>
...
<p align="center"><img src="assets/diagrams/writing.svg" alt="The writing loop: write assembles the context, the agent drafts, submit runs the gates, a block returns findings and writes nothing, deslop revises, and a decision approves the section" width="900"></p>
...
[docs/cli.md](cli.md) and the located observations behind it. `phdude prose --file <path>`
...
[ADR 10](adr/0010-renderer-adapters-and-reproducible-builds.md) says exactly how far the
promise goes.
...
using it you keep a folder, not a database dump. Details in [docs/workspace.md](workspace.md).
...
[docs/packs-authoring.md](packs-authoring.md).

## Documentation

| Page | What it answers |
|---|---|
| [docs/cli.md](cli.md) | Every command, every flag, every exit code, and which of them are stable. |
| [docs/workspace.md](workspace.md) | What is on disk, what each file means, and what is safe to edit by hand. |
| [docs/examples.md](examples.md) | The four example workspaces, what each demonstrates, and how to regenerate them. |
| [docs/agents.md](agents.md) | Setting up Claude Code, Codex, OpenCode, or anything that reads `AGENTS.md`. |
| [docs/migration.md](migration.md) | Upgrading a workspace, what each migration does, and how to write one. |
| [docs/extending.md](extending.md) | Where a change belongs: core, skill, pack or adapter. |
| [docs/extension-api.md](extension-api.md) | The seven ports, with lifecycle, errors, stability and contract suites. |
| [docs/skills-authoring.md](skills-authoring.md) | Writing a skill: the contract, the permissions, the tests. |
| [docs/packs-authoring.md](packs-authoring.md) | Writing a field, method or venue pack. |
| [docs/versioning.md](versioning.md) | What 1.0 froze, what it did not, and what a breaking change costs. |
| [docs/non-goals.md](non-goals.md) | What PhDude will never become, and why. |
| [docs/adr/](adr/) | The eleven decisions the design rests on, with the reasoning. |
...
The reasoning behind the big calls is in [docs/adr/](adr/).
...
[docs/versioning.md](versioning.md) says what that costs.
