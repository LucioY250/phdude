const LINES = [
  ...
  '  audit citations                   audit the citations: keys that resolve to nothing, claims',
  '        [--allow-network]           with no source behind them, sources nobody reviewed, and',
  '                                    DOI metadata against Crossref when the policy allows it',
  ...
  '  ready [--profile <venue>]         submission readiness: the venue rules, Research Health,',
  '                                    the policy requirements and the high-severity gaps, each',
  '                                    with the command that fixes it; exit 2 while any blocks',
