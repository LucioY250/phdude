...
function renderClaudeMd() {
  return [
    ...
    '`/phdude-add`, `/phdude-link`, `/phdude-decide`, `/phdude-cite`, `/phdude-doctor`,',
    '`/phdude-mode`, `/phdude-migrate`). Each wraps the CLI: run it with `--json` and follow the matching skill',
    'under `.phdude/skills/<name>/SKILL.md`.',
